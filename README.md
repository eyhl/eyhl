...
## Selected work
- **`SARProcessing.jl`**
  - Built parts of a Julia pipeline for turning raw satellite radar data into usable image products

- **Landslide detection in Greenland**
...
- **Glacier ice and sea ice from Landsat**
